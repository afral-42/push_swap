...
void	test_sorting_with_already_sorted_stack(void (*sort)(t_stack *))
{
	t_stack	*stack;
...
void	test_sorting_with_maximum_disorder_stack(void (*sort)(t_stack *))
{
	t_stack	*stack;
...
void	test_sorting_with_average_disorder_stack(void (*sort)(t_stack *))
{
